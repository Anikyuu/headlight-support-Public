...
export function bodyArtwork(body){
 ...
 if(body==='midnightCassette')return gradient('cassette','#090909','#161616',.62)+lines('#fff',.028)+frame('#fff',.16)+screws('#fff')+`<path d="M26 64H394M26 785H394" stroke="#fff" stroke-opacity=".09"/><rect x="25" y="177" width="370" height="303" rx="28" fill="#000" opacity=".11"/>`;
 if(body==='warmAnalog')return gradient('analog','#f5e8d1','#e3cca6',.24)+lines('#654321',.025,3)+frame('#8c5926',.68,5,9)+frame('#4f331c',.55,1.1,13,'3 4');
 if(body==='cyberSignal')return gradient('signal','#090d0d','#141717',.58)+`<defs><pattern id="body-grid" width="20" height="20" patternUnits="userSpaceOnUse"><path d="M20 0H0V20" fill="none" stroke="#ade838" stroke-opacity=".035"/></pattern></defs><rect width="420" height="913" fill="url(#body-grid)"/><g fill="none" stroke="#ade838" stroke-opacity=".4"><path d="M9 85H21V210L32 224V280M411 220H399V450L386 464V522M10 580H25V690L34 701V780M410 715H399V839H371"/><circle cx="32" cy="280" r="3"/><circle cx="386" cy="522" r="3"/></g>`+frame('#ade838',.32,1,9);
 if(body==='dreamySticker')return gradient('dream','#f5e8fc','#d1c4f0',.58)+`<defs><pattern id="pearls" width="23" height="23" patternUnits="userSpaceOnUse"><circle cx="11" cy="11" r="1" fill="#fff" opacity=".24"/></pattern></defs><rect width="420" height="913" fill="url(#pearls)"/><path d="M10 270a10 10 0 0 1 10-13 12 12 0 0 1 22 7 8 8 0 0 1-3 15H17a7 7 0 0 1-7-9" fill="#75dded" opacity=".35"/><g transform="translate(373 167) scale(.28)"><path d="${star}" fill="#ffdf45" opacity=".6"/></g><g transform="translate(370 506) scale(.28)"><path d="${star}" fill="#f08ebe" opacity=".5"/></g>`+frame('#fff',.5,1,11);
