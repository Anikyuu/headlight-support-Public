...
export function createPhoneArtwork(state, {date=new Date(), text=key=>key, appText=key=>key, transparentBackground=false,paletteOverride}={}) {
const iconPaths={
