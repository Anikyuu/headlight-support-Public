...
## First introduction: easy everyday notes

Kai identified the homepage’s first “A journal for everything you love” heading as a mismatch after feedback about the large microphone and easy voice entry. The homepage introduction now leads with “メモすることを、もっと気軽に。” / “Make taking notes feel effortless.” It describes one tap on the large microphone, speaking and the send command, then everyday uses such as shopping, things to remember and spontaneous thoughts. Voice and text both remain in the explanation. The next collection section carries the saved-link/favorites story. All eight intro translations are explicit static spans; spoken send commands match `VoiceCommand.submit(for:)` in the app, including French “envoi” and Spanish “envíalo”. This edit concerns the homepage introduction; the standalone About page was not revised.

## Human comic and humorous introduction

Kai rejected the abstract mic-to-note diagram and an ordinary human illustration. The selected replacement is a colored three-panel comic: an absurdly heavy bundle of thoughts, speaking into a phone, then floating with relief. Preserve the humorous exaggeration and expressive character. Kai considered a line-only variant, then explicitly selected the color version. The selected PNG is served locally and unchanged; its built-in image generation prompt is saved in img/voice-story/README.md.

The static strip scales with the page, with eight-language alternative text. The former diagram and playback code have been removed. The introduction welcomes important notes, passing thoughts and private gripes with a heavyweight metaphor, then separately explains one tap on the large microphone and the app’s actual spoken send command. Text entry remains explicit. The main hero copy is unchanged. This is humorous promotional imagery, not an app screenshot or a promise of confidentiality.

Kai requested as few words as possible without repeating the same phrases. After trying a comparative journal heading, Kai explicitly preferred the earlier “メモすることを、もっと気軽に。” Restore and preserve that heading in all eight languages. There is no additional introductory paragraph repeating it. Keep the comic, the humorous heavyweight copy and the short functional explanation: “マイクを一度押し、話して「送信」で保存。文字でも入力できます。”

## Three-panel stories throughout the homepage

Kai asked to extend the selected colored comic style to every item, mixing men and women and Asian, Western and Black characters, with different hair and appearances in Japanese and English. Kai explicitly rejected single-scene illustrations: each item must show three panels with a clear before/after emotional change and comic exaggeration. Twelve sections now have paired Japanese/English stories, and the opening story also has a localized English character. The Japanese edition is used for Japanese; the English edition is used for the other page languages, each with its own localized alternative text. No visible captions were added.

The comics sit beneath each section heading, with existing feature copy and actual app screenshots retained. The Words, Journal and Routines sections have full-width illustrated introductions followed by their existing screen/text content in two columns on desktop and one on mobile. The old standalone line illustration in the favorites/research section was replaced by the new story. The hero, interactive die, moving design gallery, pricing, links and approved copy are unchanged. These are visual metaphors, not depictions of additional app features.

See `img/feature-comics/README.md` and `generation-manifest.json` for the selected assets and full built-in generation prompts. Single-scene drafts and superseded corrections are not page assets.
